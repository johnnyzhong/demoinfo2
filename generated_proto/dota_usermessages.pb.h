...
const EDotaUserMessages EDotaUserMessages_MAX = DOTA_UM_ItemFound;
...
const DOTA_CHAT_MESSAGE DOTA_CHAT_MESSAGE_MAX = CHAT_MESSAGE_RD_TURN;
...
const EDotaEntityMessages EDotaEntityMessages_MAX = DOTA_UNIT_FADE_GESTURE;
...
const DOTA_PARTICLE_MESSAGE DOTA_PARTICLE_MESSAGE_MAX = DOTA_PARTICLE_MANAGER_EVENT_LATENCY;
...
const DOTA_OVERHEAD_ALERT DOTA_OVERHEAD_ALERT_MAX = OVERHEAD_ALERT_BONUS_POISON_DAMAGE;
...
inline ::google::protobuf::uint32 CDOTAUserMsg_CombatLogData::type() const {
  return type_;
}
inline void CDOTAUserMsg_CombatLogData::set_type(::google::protobuf::uint32 value) {
  set_has_type();
  type_ = value;
}
